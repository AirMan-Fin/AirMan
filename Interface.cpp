...
Interface::Interface(Clock *c, int rs, int en, int d4, int d5, int d6, int d7) {
	...
	settingsMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
	...
	roomSpaceMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
	roomTypeMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
	roomHeatRecoverMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
	roomWindowsMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
	roomTempMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);

	settingsClockMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
	settingsBrightnessMenu->init(menuHandler->getpCurrent(), menuHandler->getpVector(), lcd);
